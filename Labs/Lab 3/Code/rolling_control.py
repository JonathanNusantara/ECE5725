...
my_buttons = {'STOP':(160, 120), 'RESUME':(160, 120), 'Left History':(60,20), 'Right History':(250,20), 'QUIT':(220,200)} # Make quit button
...
def control(motor_num, direction):
	if stop == False: # Only change motor mode if not in stop state
		if motor_num == 1: # left
			if direction == 0: # stop
